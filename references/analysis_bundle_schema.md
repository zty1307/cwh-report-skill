...
- Each mature cluster normally cites 2-4 selected independent voices. Preserve one complete attributed claim per voice, normally 100-200 characters (punctuation included, attribution and whitespace excluded; a soft target). A thinner cluster must include `thin_cluster_exception` backed by completed search evidence.
